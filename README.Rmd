...
Details given when `show_details = TRUE` in `fetch_five_digit` are slightly different than they are for `fetch_zones` (see [Details](https://github.com/aedobbyn/usps#details)).
