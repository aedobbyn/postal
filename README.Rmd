...
Supply an origin and, optionally, a destination zip as character or numeric.
...
Rows corresponding to origin zones that are not in use get `NA`s in their destination and zone columns.
