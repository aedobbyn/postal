...
Since we specified `type = "box"`, we get back all the options for boxes along with their prices and dimensions. 
...
So to answer the burning question...what if we wanted to ship live animals from Wyoming to Philly by ground at 2:30pm in a nonrectangular package?? How long will it take and how much will it cost?
...
Sometimes you just need to know the shipping zone between your origin and destination. Or may between *all* origins and *all* destinations for some app you're building.
